...
setwd("/vf/users/Wilson_Lab/squamates/Heloderma_sexchr/gametolog_analysis/sheffermannm/varanus_only")
...
ref_z <- read_tsv("../../Varanus_acanthurus/Varanus_acanthurus_chrZ.gff3.gz", comment = "#", col_names = c("seqid","source","type","start","end","score","strand","phase","attributes"), show_col_types = FALSE)
ref_w <- read_tsv("../../Varanus_acanthurus/Varanus_acanthurus_chrW.gff3.gz", comment = "#", col_names = c("seqid","source","type","start","end","score","strand","phase","attributes"), show_col_types = FALSE)
