...
zcat Varanus_acanthurus/Varanus_acanthurus_chrZ.peptides.fasta.gz \
| awk '
BEGIN{RS=">"; ORS=""}
NR>1{
    n=split($0,a,"\n")
    ...
    if(seq !~ /\./)
        print ">" hdr "\n" seq "\n"
}' > Varanus_acanthurus/Varanus_acanthurus_chrZ.peptides.clean.fasta

# Now make database
diamond makedb --in Varanus_acanthurus/Varanus_acanthurus_chrZ.peptides.clean.fasta -d Varanus_acanthurus/Varanus_acanthurus_chrZ.peptides.dmnd
...
zcat Varanus_acanthurus/Varanus_acanthurus_chrW.peptides.fasta.gz \
| awk '
BEGIN{RS=">"; ORS=""}
NR>1{
    n=split($0,a,"\n")
    ...
    if(seq !~ /\./)
        print ">" hdr "\n" seq "\n"
}' > Varanus_acanthurus/Varanus_acanthurus_chrW.peptides.clean.fasta

# Blast each W gene against all Z genes
diamond blastp -d Varanus_acanthurus/Varanus_acanthurus_chrZ.peptides.dmnd -q Varanus_acanthurus/Varanus_acanthurus_chrW.peptides.clean.fasta -o sheffermannm/varanus_only/blast_results/wGenes_to_all_zGenes_all_isoforms.tsv --unal 1 --max-target-seqs 5 --header
...
}' sheffermannm/varanus_only/blast_results/wGenes_to_all_zGenes_all_isoforms.tsv > sheffermannm/varanus_only/blast_results/wGenes_zGenes.tsv
