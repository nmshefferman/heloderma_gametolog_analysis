...
#SBATCH -o heloderma_gametolog_blast_wGenes_ZGenes.out
#SBATCH -e heloderma_gametolog_blast_wGenes_ZGenes.err   
#SBATCH --mem=10g
...
diamond blastp -d ../references/Heloderma_suspectum.chrZ-only.peptides.dmnd -q ../references/Heloderma_suspectum.chrW-only_PAR-masked.peptides.fasta.gz -o blast_results/wGenes_to_all_zGenes_all_isoforms.tsv --unal 1 --max-target-seqs 5 --header
